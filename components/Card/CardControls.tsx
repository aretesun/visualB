    ...
    <div className="absolute bottom-2 right-2 flex space-x-2 opacity-0 group-hover:opacity-100 [@media(hover:none)]:opacity-100 [@media(hover:none)]:touch-none transition-opacity duration-200 z-20">
      ...
      {hasImage && (
        <button
          ...
          className={`p-2.5 sm:p-2 rounded-md shadow-lg touch-manipulation ${
            isImageLocked
      ...
      {hasText && !isEditingText && (
        <button
          ...
          onMouseDown={(e) => e.stopPropagation()}
          className="p-2.5 sm:p-2 bg-white/20 hover:bg-white/30 rounded-md shadow-lg touch-manipulation"
          aria-label="Edit text"
        >
          <EditIcon className="w-5 h-5 sm:w-4 sm:h-4 text-white" />
        </button>
      )}
      ...
      {isEditingText && (
        <button
          ...
          onMouseDown={(e) => e.stopPropagation()}
          className="p-2.5 sm:p-2 bg-green-500/80 hover:bg-green-500 rounded-md shadow-lg touch-manipulation"
          aria-label="Save changes"
        >
          <CheckIcon className="w-5 h-5 sm:w-4 sm:h-4 text-white" />
        </button>
      )}
      ...
      {hasImage && !isEditingImage && (
        <button
          ...
          onMouseDown={(e) => e.stopPropagation()}
          className="p-2.5 sm:p-2 bg-blue-500/80 hover:bg-blue-500 rounded-md shadow-lg touch-manipulation"
      ...
      >
        <TrashIcon className="w-5 h-5 sm:w-4 sm:h-4 text-white" />
      </button>
    </div>
  );
};
